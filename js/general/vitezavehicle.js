// Funcția care calculează vitezele pentru diferite etape
...
// Funcția care populază tabelul cu datele vehiculelor
function populateTable() {
    ...
    // Verifică calculul vitezelor pentru un exemplu de viteză
    console.log(calculateSpeeds(100));

    // Iterează prin datele vehiculului și adaugă rânduri în tabel
    data.forEach(car => {
        const speeds = calculateSpeeds(car.stockSpeed);
        const row = document.createElement("tr");

        // Adaugă celula cu numele vehiculului
        const nameCell = document.createElement("td");
        nameCell.textContent = car.name;
        row.appendChild(nameCell);

        // Adaugă celula cu viteza de stoc
        ...
        // Adaugă celulele pentru vitezele calculate
...
// Apelează funcția populateTable când pagina este complet încărcată
